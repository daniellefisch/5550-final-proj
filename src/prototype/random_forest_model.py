...
def main(
    data_path: str | Path = "data/clean/merged_model_data.csv",
    output_dir: str | Path = "outputs",
) -> None:
    output_dir = Path(output_dir)
    output_dir.mkdir(parents=True, exist_ok=True)

    # load clean model data
    ...
    # within region eval - cv on corn belt
    ...
    all_preds.to_csv(output_dir / "random_forest_predictions.csv", index=False)
    ...
    metrics_df.to_csv(output_dir / "random_forest_metrics.csv", index=False)
