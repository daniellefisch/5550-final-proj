...
def main():
    ...
    metrics_path = OUTPUT_DIR / "gradient_boost_metrics.csv"
    ...
    importance_path = OUTPUT_DIR / "gradient_boost_feature_importances.csv"
    ...
    preds_path = OUTPUT_DIR / "gradient_boost_transfer_predictions.csv"
    ...
    cb_preds_path = OUTPUT_DIR / "gradient_boost_gp_to_cb_transfer_predictions.csv"
